              ...
              <div className="p-4 space-y-14">
                ...
                <div className="h-20 bg-slate-50/30 rounded-lg flex flex-col justify-center py-3 px-3">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="text-right">
                      <span className="text-lg font-bold text-slate-800">$350</span>
                      <span className="text-xs text-slate-500 ml-1">/year</span>
                    </div>
                  </div>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Exit planning tools & low discounts or commissions on client licenses
                  </p>
                </div>
                ...
                <div className="h-20 bg-slate-50/30 rounded-lg flex flex-col justify-center py-3 px-3">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Unlimited "Mini" accounts and maximum discounts or commissions on client licenses
                  </p>
                </div>
